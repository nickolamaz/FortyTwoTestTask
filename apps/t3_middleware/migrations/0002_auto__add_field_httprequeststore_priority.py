...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HttpRequestStore.priority'
        db.add_column(u't3_middleware_httprequeststore', 'priority',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HttpRequestStore.priority'
        db.delete_column(u't3_middleware_httprequeststore', 'priority')
